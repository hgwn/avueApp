...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message sureBtn:(NSString *)sureTitle cancleBtn:(NSString *)cancleTitle
{
    if (self == [super init]) {
        ...
        if (title) {
            ...
            self.titleLbl = [self GetAdaptiveLable:CGRectMake(2*XLSpace, 4*XLSpace, AlertW-4*XLSpace, 20) AndText:title andIsTitle:YES];
            self.titleLbl.textAlignment = NSTextAlignmentCenter;
            
            [self.alertView addSubview:self.titleLbl];
            
            CGFloat titleW = self.titleLbl.bounds.size.width+40;
            CGFloat titleH = self.titleLbl.bounds.size.height;
            
            self.titleLbl.font = [UIFont systemFontOfSize:20.f];
        ...
        if (message) {
            ...
            self.msgLbl.frame = self.titleLbl?CGRectMake((AlertW-msgW)/2, CGRectGetMaxY(self.titleLbl.frame)+XLSpace+15, msgW, msgH):CGRectMake((AlertW-msgW)/2, 2*XLSpace, msgW, msgH);
        }
        ...
        if (cancleTitle && sureTitle) {
            ...
            self.cancleBtn.frame = CGRectMake(20, CGRectGetMaxY(self.lineView.frame), ((AlertW-1)/2)-20, 40);
            ...
            self.cancleBtn.layer.borderColor = [UIColor redColor].CGColor;
        ...
        if(sureTitle && cancleTitle){
            ...
            self.sureBtn.frame = CGRectMake(CGRectGetMaxX(self.verLineView.frame)+10, CGRectGetMaxY(self.lineView.frame), ((AlertW-1)/2+1)-30, 40);
            [self.sureBtn setBackgroundImage:[self imageWithColor:[UIColor colorWithRed:229/255.0 green:49/255.0 blue:65/255.0 alpha:0.2]] forState:UIControlStateNormal];
        ...
        if(sureTitle && !cancleTitle){
            ...
            self.sureBtn = [UIButton buttonWithType:UIButtonTypeSystem];
            self.sureBtn.frame = CGRectMake(20, CGRectGetMaxY(self.lineView.frame)+20, AlertW-40, 40);
        ...
        self.alertView.frame = CGRectMake(0, 0, AlertW, alertHeight+30);
        self.alertView.layer.position = self.center;
